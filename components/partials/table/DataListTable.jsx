      ...
      <Card>
        ...
        <div className="md:flex md:space-y-0 space-y-5 justify-between mt-6 items-center">
          <div className=" flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span className="text-sm font-medium text-black-500 dark:text-slate-300">
              Page{" "}
              <span>
          ...
          <ul className="flex items-center  space-x-3  rtl:space-x-reverse flex-wrap">
            <li className="text-xl leading-4 text-black-500 dark:text-white rtl:rotate-180">
              <button
                className={` ${
            ...
            <li className="text-sm leading-4 text-black-500 dark:text-white rtl:rotate-180">
              <button
                className={` ${
                  !canPreviousPage ? "opacity-50 cursor-not-allowed" : ""
                }`}
